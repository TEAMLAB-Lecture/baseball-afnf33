...
def get_not_duplicated_three_digit_number():
    ...
    while not is_validated_number(number):
        number = str(get_random_number())
    result = number
    # ==================================
    return result
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    one_more = one_more_input.lower()
    result = one_more == 'y' or one_more == 'yes'
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    one_more = one_more_input.lower()
    result = one_more == 'n' or one_more == 'no'
    # ==================================
    return result
...
def main():
    ...
    while True:
        ...
        if strikes == 3:
            ...
            while not (is_yes(one_more) or is_no(one_more)):
                print("Wrong Input, Input again")
                one_more = input("You win, one more (Y/N)?")
            if is_yes(one_more):
                random_number = str(get_not_duplicated_three_digit_number())
